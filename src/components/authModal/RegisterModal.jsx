...
export default function RegisterModal({
  ...
  const handleSignup = (e) => {
    ...
    const trimmedPhone = defaultPhone.trim();
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="p-0 border-none max-w-[400px] sm:max-w-[490px] max-h-screen overflow-auto">
        <div className="max-w-[400px] sm:max-w-[490px] top-[12%] px-8 py-4 rounded-[11px] bg-white mx-auto">
          ...
          <div className="grid items-center gap-4 w-full">
            ...
            <div className="py-2">
              <h2 className="text-[20px] font-medium">Registration</h2>
