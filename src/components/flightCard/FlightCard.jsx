...
export default function FlightCard() {
  return (
    <div className="w-full  md:w-[985px]  bg-white rounded-lg shadow-md overflow-hidden mt-5 h-fit">
      <div className=" grid grid-cols-1 md:grid-cols-4 lg:grid-cols-7 place-items-center ">
